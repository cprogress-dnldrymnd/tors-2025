...
function test()
{
    ...
    foreach ($artists as $artist) {
        ...
        while ($query_recordings->have_posts()) {
            ...
            echo '<div class="play-pause-btn play" target="' . $before_audio . '"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16"> <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393"/> </svg></div>';
            ...
            echo '<div class="audio-current-time" id="audio-' . $before_audio . '-duration">00:00</div>';
            echo '<div class="audio-duration" id="audio-' . $before_audio . '-current-time">00:00</div>';
            echo '</div>';
