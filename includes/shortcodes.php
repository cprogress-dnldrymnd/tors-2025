...
function artist_box($atts)
{
    ...
    if ($video) {
        echo '<a data-fancybox="video-gallery" href="' . convertToEmbedLink($video) . '" ><svg xmlns="http://www.w3.org/2000/svg" width="52.005" height="37.733" viewBox="0 0 52.005 37.733">
